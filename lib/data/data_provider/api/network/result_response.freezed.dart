...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$ResultResponseCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> with DiagnosticableTreeMixin implements Success<T> {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ResultResponse<$T>.success(data: $data)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ResultResponse<$T>.success'))
...
abstract class Success<T> implements ResultResponse<T> {
...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$ResultResponseCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> with DiagnosticableTreeMixin implements Failure<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ResultResponse<$T>.failure(error: $error)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ResultResponse<$T>.failure'))
...
abstract class Failure<T> implements ResultResponse<T> {
