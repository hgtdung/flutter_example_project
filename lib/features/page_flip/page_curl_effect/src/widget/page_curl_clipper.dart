...
class PageCurlClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    if (cylinder.angle == 0) {
      ...
      var horizontalEndPoint = horizontalPageCurl.endPoint;
      var horizontalStartPoint = horizontalPageCurl.startPoint;
      var horizontalFoldPoint = horizontalPageCurl.foldPoint;

      /// Fix t_c of Quadratic Bezier curve
      double t_c = 0.3;
      FPoint horizontalControlPoint = PCMath.calculateControlPoint(
          horizontalStartPoint, horizontalEndPoint, horizontalFoldPoint, t_c);
