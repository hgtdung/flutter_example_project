...
class PCMath {
  ...
  static FPoint calculateControlPoint(FPoint a, FPoint b, FPoint c, double t_c) {
    double x1 = (c.x - (1 - t_c) * (1 - t_c) * a.x - t_c * t_c * b.x) / (2 * t_c * (1 - t_c));
    double y1 = (c.y - (1 - t_c) * (1 - t_c) * a.y - t_c * t_c * b.y) / (2 * t_c * (1 - t_c));
    return FPoint(x1, y1);
  }
