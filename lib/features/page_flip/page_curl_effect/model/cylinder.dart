...
class Cylinder {
  ...
  final FPoint centerTop;
  final FPoint bottomLeft;
  final FPoint bottomRight;
  final FPoint centerBottom;
  final FPoint center;
  final double range;
  final double angle;
  ...
  Cylinder rotateBy(double newAngle, {FPoint? newPivot}) {
    ...
    var centerTopOxy = centerTop.toOrigin();
    var centerBottomOxy = centerBottom.toOrigin();
