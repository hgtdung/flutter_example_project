...
mixin _$ResultState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            NetworkExceptions error, String? errorServerId, int? errorField)
        error,
  }) =>
...
class __$$EmptyImplCopyWithImpl<T, $Res>
    extends _$ResultStateCopyWithImpl<T, $Res, _$EmptyImpl<T>>
...
abstract class Empty<T> implements ResultState<T> {
...
abstract class _$$ErrorImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({NetworkExceptions error, String? errorServerId, int? errorField});
...
class __$$ErrorImplCopyWithImpl<T, $Res>
  ...
  $Res call({
    ...
    return _then(_$ErrorImpl<T>(
      ...
      freezed == errorServerId
          ? _value.errorServerId
          : errorServerId // ignore: cast_nullable_to_non_nullable
              as String?,
      freezed == errorField
          ? _value.errorField
...
class _$ErrorImpl<T> implements Error<T> {
  const _$ErrorImpl(this.error, [this.errorServerId, this.errorField]);

  @override
  final NetworkExceptions error;
  @override
  final String? errorServerId;
  @override
  final int? errorField;

  @override
  String toString() {
    return 'ResultState<$T>.error(error: $error, errorServerId: $errorServerId, errorField: $errorField)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.errorServerId, errorServerId) ||
                other.errorServerId == errorServerId) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, error, errorServerId, errorField);
  ...
  TResult when<TResult extends Object?>({
    ...
    return error(this.error, errorServerId, errorField);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(this.error, errorServerId, errorField);
  }
...
abstract class Error<T> implements ResultState<T> {
  const factory Error(final NetworkExceptions error,
      [final String? errorServerId, final int? errorField]) = _$ErrorImpl<T>;

  NetworkExceptions get error;
  String? get errorServerId;
  int? get errorField;
  @JsonKey(ignore: true)
  _$$ErrorImplCopyWith<T, _$ErrorImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
